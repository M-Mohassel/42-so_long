...
/*   Updated: 2023/04/25 13:12:49 by misi-moh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	(*data)->enemy_movement[0] = (t_pos *)malloc(sizeof(t_pos));
	(*data)->enemy_movement[1] = (t_pos *)malloc(sizeof(t_pos));
	(*data)->enemy_movement[2] = (t_pos *)malloc(sizeof(t_pos));
	(*data)->enemy_movement[3] = (t_pos *)malloc(sizeof(t_pos));
